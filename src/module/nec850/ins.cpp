...
const instruc_t Instructions[] =
{
  ...
  { "stsr",           CF_USE1|CF_CHG2|CF_USE3         }, // Store Contents of System Register
  { "st.b",           CF_USE1|CF_CHG2                 }, // Store byte
  { "st.h",           CF_USE1|CF_CHG2                 }, // Store half-word
  { "st.w",           CF_USE1|CF_CHG2                 }, // Store word
  { "sst.b",          CF_USE1|CF_CHG2                 }, // Store byte (use EP)
  { "sst.h",          CF_USE1|CF_CHG2                 }, // Store half-word (use EP)
  { "sst.w",          CF_USE1|CF_CHG2                 }, // Store word (use EP)
  { "sld.b",          CF_USE1|CF_CHG2                 }, // Load byte (use EP)
  { "sld.h",          CF_USE1|CF_CHG2                 }, // Load half-word (use EP)
  { "sld.w",          CF_USE1|CF_CHG2                 }, // Load word (use EP)
  { "shr",            CF_USE1|CF_USE2|CF_CHG2|CF_SHFT }, // Shift Logical Right (excl Format XI)
  { "shl",            CF_USE1|CF_USE2|CF_CHG2|CF_SHFT }, // Shift Logical Left (excl Format XI)
  ...
  { "satsub",         CF_USE1|CF_USE2|CF_CHG2         }, // Saturated Subtract (excl Format XI)
  { "satadd",         CF_USE1|CF_USE2|CF_CHG2         }, // Saturated Add (excl Format XI)
  { "sar",            CF_USE1|CF_USE2|CF_CHG2|CF_SHFT }, // Shift Arithmetic Right (excl Format XI)
  { "reti",           CF_STOP                         }, // Return from Trap or Interrupt
  { "ori",            CF_USE1|CF_USE2|CF_CHG3         }, // OR immediate
  ...
  { "ldsr",           CF_USE1|CF_CHG2|CF_USE3         }, // Load to system register
  ...
  { "jarl",           CF_USE1|CF_CHG2|CF_CALL         }, // Jump and Register Link
  { "halt",           CF_STOP                         }, // Halt
  { "ei",             0                               }, // Enable interrupt
  { "divh",           CF_USE1|CF_USE2|CF_CHG2         }, // Divide Half-Word (excl Format XI)
  ...
  { "dispose",        CF_USE1|CF_CHG2                 }, // Function dispose
  { "dispose",        CF_USE1|CF_CHG2|CF_USE3|CF_STOP }, // Function dispose
  ...
  { "divh",           CF_USE1|CF_USE2|CF_CHG2|CF_CHG3 }, // Divide halfword (Format XI)
  ...
  // V850E2M
  //
  { "caxi",           CF_USE1|CF_CHG1|CF_USE2|CF_CHG3 }, // Compare and exchange for interlock
  ...
  { "addf.d",         CF_USE1|CF_USE2|CF_CHG3         }, // Floating-point Add (Double)
  { "addf.s",         CF_USE1|CF_USE2|CF_CHG3         }, // Floating-point Add (Single)
  { "divf.d",         CF_USE1|CF_USE2|CF_CHG3         }, // Floating-point Divide (Double)
  { "divf.s",         CF_USE1|CF_USE2|CF_CHG3         }, // Floating-point Divide (Single)
  { "maxf.d",         CF_USE1|CF_USE2|CF_CHG3         }, // Floating-point Maximum (Double)
  { "maxf.s",         CF_USE1|CF_USE2|CF_CHG3         }, // Floating-point Maximum (Single)
  { "minf.d",         CF_USE1|CF_USE2|CF_CHG3         }, // Floating-point Minimum (Double)
  { "minf.s",         CF_USE1|CF_USE2|CF_CHG3         }, // Floating-point Minimum (Single)
  { "mulf.d",         CF_USE1|CF_USE2|CF_CHG3         }, // Floating-point Multiply (Double)
  { "mulf.s",         CF_USE1|CF_USE2|CF_CHG3         }, // Floating-point Multiply (Single)
  ...
  { "subf.d",         CF_USE1|CF_USE2|CF_CHG3         }, // Floating-point Subtract (Double)
  { "subf.s",         CF_USE1|CF_USE2|CF_CHG3         }, // Floating-point Subtract (Single)
  ...
  { "cmpf.s",         CF_USE1|CF_USE2|CF_USE3|CF_USE4 }, // Compares floating-point values (Single)
  { "cmpf.d",         CF_USE1|CF_USE2|CF_USE3|CF_USE4 }, // Compares floating-point values (Double)
  { "cmovf.s",        CF_USE1|CF_USE2|CF_USE3|CF_CHG4 }, // Floating-point conditional move (Single)
  { "cmovf.d",        CF_USE1|CF_USE2|CF_USE3|CF_CHG4 }, // Floating-point conditional move (Double)
  { "trfsr",          CF_USE1                         }, // Transfers specified CC bit to Zero flag in PSW (Single)
  ...
  { "st.dw",          CF_USE1|CF_CHG2                 }, // Store Double Word
  { "ldl.w",          CF_USE1|CF_CHG2                 }, // Load Linked
  { "stc.w",          CF_USE1|CF_CHG1|CF_CHG2         }, // Store Conditional
  ...
  { "fmaf.s",         CF_USE1|CF_USE2|CF_USE3|CF_CHG3 }, // Floating-point Fused-Multiply-add (Single)
  { "fmsf.s",         CF_USE1|CF_USE2|CF_USE3|CF_CHG3 }, // Floating-point Fused-Multiply-subtract (Single)
  { "fnmaf.s",        CF_USE1|CF_USE2|CF_USE3|CF_CHG3 }, // Floating-point Fused-Negate-Multiply-add (Single)
  { "fnmsf.s",        CF_USE1|CF_USE2|CF_USE3|CF_CHG3 }, // Floating-point Fused-Negate-Multiply-subtract (Single)
  ...
  // round instructions
  { "roundf.dl",      CF_USE1|CF_CHG2                 }, // Floating-point Convert Double to Long, round to nearest (Double)
  { "roundf.dw",      CF_USE1|CF_CHG2                 }, // Floating-point Convert Double to Word, round to nearest (Double)
  { "roundf.dul",     CF_USE1|CF_CHG2                 }, // Floating-point Convert Double to Unsigned-Long, round to nearest (Double)
  { "roundf.duw",     CF_USE1|CF_CHG2                 }, // Floating-point Convert Double to Unsigned-Word, round to nearest (Double)
  { "roundf.sl",      CF_USE1|CF_CHG2                 }, // Floating-point Convert Single to Long, round to nearest (Single)
  { "roundf.sw",      CF_USE1|CF_CHG2                 }, // Floating-point Convert Single to Word, round to nearest (Single)
  { "roundf.sul",     CF_USE1|CF_CHG2                 }, // Floating-point Convert Single to Unsigned-Long, round to nearest (Single)
  { "roundf.suw",     CF_USE1|CF_CHG2                 }, // Floating-point Convert Single to Unsigned-Word, round to nearest (Single)

  { "ldm.mp",         CF_USE1|CF_USE2                 }, // Load Multiple MPU entries from memory
  { "stm.mp",         CF_USE1|CF_USE2                 }, // Store Multiple MPU entries to memory

  { "clip.b",         CF_USE1|CF_CHG2                 }, // Signed data conversion from word to byte with saturation
  { "clip.bu",        CF_USE1|CF_CHG2                 }, // Unsigned data conversion from word to byte with saturation
  { "clip.h",         CF_USE1|CF_CHG2                 }, // Signed data conversion from word to halfword with saturation
  { "clip.hu",        CF_USE1|CF_CHG2                 }, // Unsigned data conversion from word to halfword with saturation
  ...
  { "stc.b",          CF_USE1|CF_CHG1|CF_CHG2         }, // Store conditional byte
  { "stc.h",          CF_USE1|CF_CHG1|CF_CHG2         }, // Store conditional halfword
  ...
  { "vld.b",          CF_USE1|CF_CHG2                 }, // Vector Load byte
  { "vld.b",          CF_USE1|CF_USE2|CF_CHG3         }, // Vector Load byte (3rd instruction format)
  { "vld.b",          CF_USE1|CF_USE2|CF_CHG2|CF_CHG3 }, // Vector Load byte (4th instruction format)

  { "vld.h",          CF_USE1|CF_CHG2                 }, // Vector Load halfword
  { "vld.h",          CF_USE1|CF_USE2|CF_CHG3         }, // Vector Load halfword (3rd instruction format)
  { "vld.h",          CF_USE1|CF_USE2|CF_CHG2|CF_CHG3 }, // Vector Load halfword (4th instruction format)

  { "vld.w",          CF_USE1|CF_CHG2                 }, // Vector Load word
  { "vld.w",          CF_USE1|CF_USE2|CF_CHG3         }, // Vector Load word (3rd instruction format)
  { "vld.w",          CF_USE1|CF_USE2|CF_CHG2|CF_CHG3 }, // Vector Load word (4th instruction format)

  { "vld.dw",         CF_USE1|CF_CHG2                 }, // Vector Load double - word
  { "vld.dw",         CF_USE1|CF_USE2|CF_CHG3         }, // Vector Load double - word (3rd instruction format)
  { "vld.dw",         CF_USE1|CF_USE2|CF_CHG2|CF_CHG3 }, // Vector Load double - word (4th instruction format)

  { "vst.b",          CF_USE1|CF_CHG2                 }, // Vector Store byte
  { "vst.b",          CF_USE1|CF_CHG2|CF_USE3         }, // Vector Store byte (3rd instruction format)
  { "vst.b",          CF_USE1|CF_CHG2|CF_USE3|CF_CHG3 }, // Vector Store byte (4th instruction format)

  { "vst.h",          CF_USE1|CF_CHG2                 }, // Vector Store halfword
  { "vst.h",          CF_USE1|CF_CHG2|CF_USE3         }, // Vector Store halfword (3rd instruction format)
  { "vst.h",          CF_USE1|CF_CHG2|CF_USE3|CF_CHG3 }, // Vector Store halfword (4th/5th instruction format)

  { "vst.w",          CF_USE1|CF_CHG2                 }, // Vector Store word
  { "vst.w",          CF_USE1|CF_CHG2|CF_USE3         }, // Vector Store word (3rd instruction format)
  { "vst.w",          CF_USE1|CF_CHG2|CF_USE3|CF_CHG3 }, // Vector Store word (4th/5th instruction format)

  { "vst.dw",         CF_USE1|CF_CHG2                 }, // Vector Store double - word
  { "vst.dw",         CF_USE1|CF_CHG2|CF_USE3         }, // Vector Store double - word (3rd instruction format)
  { "vst.dw",         CF_USE1|CF_CHG2|CF_USE3|CF_CHG3 }, // Vector Store double - word (4th/5th instruction format)

  { "vcmov",          CF_USE1|CF_USE2|CF_USE3|CF_CHG4 }, // Vector conditional move
  { "modadd",         CF_USE1|CF_CHG1                 }, // Modulo Add
  ...
  { "vmaxgt.h",       CF_USE1|CF_CHG1|CF_USE2|CF_CHG3 }, // Vector maximum greater-than halfword
  { "vmaxge.h",       CF_USE1|CF_CHG1|CF_USE2|CF_CHG3 }, // Vector maximum greater-than-equal halfword
  { "vminlt.h",       CF_USE1|CF_CHG1|CF_USE2|CF_CHG3 }, // Vector minimum less-than halfword
  { "vminle.h",       CF_USE1|CF_CHG1|CF_USE2|CF_CHG3 }, // Vector minimum less-than-equal halfword
  { "vmaxgt.w",       CF_USE1|CF_CHG1|CF_USE2|CF_CHG3 }, // Vector maximum greater-than word
  { "vmaxge.w",       CF_USE1|CF_CHG1|CF_USE2|CF_CHG3 }, // Vector maximum greater-than-equal word
  { "vminlt.w",       CF_USE1|CF_CHG1|CF_USE2|CF_CHG3 }, // Vector minimum less-than word
  { "vminle.w",       CF_USE1|CF_CHG1|CF_USE2|CF_CHG3 }, // Vector minimum less-than-equal word
  ...
  { "ldvz.h4",        CF_USE1|CF_CHG2                 }, // Load Vector at Even Halfword field

  { "stv.dw",         CF_USE1|CF_USE2|CF_CHG3         }, // Store Vector (Double-Word)
  { "stv.qw",         CF_USE1|CF_CHG2                 }, // Store Vector (Quad-Word)
  { "stv.w",          CF_USE1|CF_USE2|CF_CHG3         }, // Store Vector (Word)
  { "stvz.h4",        CF_USE1|CF_CHG2                 }, // Store Vector at Even Halfword field
