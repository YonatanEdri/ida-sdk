...
#define RETERR(Format, ...) do { errbuf->sprnt(Format, __VA_ARGS__); return false; } while ( false )
  ...
  } callbacks[] =
  {
    ...
    { S_ON_GET_DIRTREE,      CFEAT_GETDIRTREE, OBSOLETE_CH_HAS_DIRTREE, 0 },
    { S_ON_INDEX_TO_INODE,   CFEAT_INDEX2INODE, OBSOLETE_CH_HAS_DIRTREE, 0 },
    { S_ON_INDEX_TO_DIFFPOS, CFEAT_INDEX2DIFFPOS, CH_HAS_DIFF, 0 },
    { S_ON_LAZY_LOAD_DIR,    CFEAT_LAZYLOADDIR, OBSOLETE_CH_HAS_DIRTREE, OBSOLETE_CH2_LAZY_LOADED },
  };
